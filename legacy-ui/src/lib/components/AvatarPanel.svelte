...
<section class="card grid">
  <h3>Avatar</h3>
  <small class="muted">Upload and save the avatar here. The live rigged avatar now renders from the main session instead of a separate popup workflow.</small>
  ...
  <small class="muted">Changes apply immediately to the embedded session avatar.</small>
</section>
